...
public class SodiumConfig {
    ...
    private SodiumConfig() {
        ...
        this.addMixinRule("features.chunk_rendering", false);
        this.addMixinRule("features.debug", false);
        this.addMixinRule("features.entity", true);
        this.addMixinRule("features.entity.fast_render", false);
        this.addMixinRule("features.entity.smooth_lighting", false);
